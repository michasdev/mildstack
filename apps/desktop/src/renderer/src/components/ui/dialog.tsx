...
export function DialogFooter({
  ...
  const defaultProps = {
    className: cn(
      ...
      variant === "default" && "border-t-border border-t bg-muted/72 py-4",
      variant === "bare" &&
